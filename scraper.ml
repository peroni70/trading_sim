...
(** [stock] is the representation of a stock's historical data. Contains a 
    ticker symbol, a list of opening prices, daily highest prices, daily lowest
    prices, closing prices, volumes, and the start day of the stock's
    historical data. *)
type stock = {
  ticker : string;
