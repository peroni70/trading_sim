...
(** [sell state stocks ticker amount] executes a sale of [ticker] with
    [amount] shares, returning a new state with the values updated as necessary.
...
(** [short state stocks ticker amount] executes a short of [ticker] with
    [amount] shares, returning a new state with the values updates as necessary.
    Raises [Broke] if the ticker is invalid*)
